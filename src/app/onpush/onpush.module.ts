...
import { ABBAComponent } from './a-b-b-a onpush/a-b-b-a.component';
...
@NgModule({
	declarations: [OnpushComponent, AComponent, AAComponent, AAAComponent, AAAAComponent, AAABComponent, AAACComponent, AABComponent, AABAComponent, AABBComponent, ABComponent, ABAComponent, ABAAComponent, ABABComponent, ABBComponent, ABBAComponent, ABBAAComponent, ABBBComponent, ABBBAComponent],
	imports: [
		CommonModule,
		SharedModule
	]
